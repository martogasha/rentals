                                ...
                                <div class="_prt_filt_dash">
                                    ...
                                    <div class="_prt_filt_dash_last m2_hide">
                                        <div class="_prt_filt_add_new">
                                            <a href="{{'addProperty'}}" class="prt_submit_link"><i class="fas fa-plus-circle"></i><span class="d-none d-lg-block d-md-block">New Property</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" class="m2_hide">Location</th>
                                                <th scope="col" class="m2_hide">Houses</th>
                                                <th scope="col" class="m2_hide">Vacant Houses</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="m2_hide">
                                                    <div class="_leads_view"><h5 class="up">Kikuyu</h5></div>
                                                    <div class="_leads_view_title"><span>Near Muguku</span></div>

                                                </td>
                                                <td class="m2_hide">
                                                    <div class="_leads_view"><h5 class="up">816</h5></div>
                                                    <div class="_leads_view_title"><span>Total Houses</span></div>
                                                </td>
                                                <td class="m2_hide">
                                                    <div class="_leads_view"><h5 class="up" style="color: red">20</h5></div>
                                                    <div class="_leads_view_title"><span>Vacant Houses</span></div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="_leads_action">
                                                        <a href="{{'propertyDetail'}}"><i class="fas fa-eye"></i></a>
