                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="_leads_status"><span class="active" style="color: red">Not Paid</span></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="m2_hide">
                                                    <div class="_leads_view"><h5 class="up">Kiambu</h5></div>
                                                    <div class="_leads_view_title"><span>Near Nova</span></div>

                                                </td>
                                                <td>
                                                    <div class="_leads_status"><span class="active">Paid</span></div>
                                                </td>
                                                <td>
                                                    <div class="_leads_action">
                                                        <a href="{{'propertyDetail'}}"><i class="fas fa-eye"></i></a>
