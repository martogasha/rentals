...
<!-- Mirrored from themezhub.net/rentup-live/rentup/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 10:21:06 GMT -->
<head>
    <meta charset="utf-8" />
            ...
            <nav id="navigation" class="navigation navigation-landscape">
                ...
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu">
                        ...
                        <li class="active"><a href="{{url('admin')}}">Dashboard<span class="submenu-indicator"></span></a>
                        </li>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="property_dashboard_navbar">
                        ...
                        <div class="dash_user_menues">
                            <ul>
                                <ul>
                                    <li class="active"><a href="{{url('admin')}}"><i class="fa fa-tachometer-alt"></i>Dashboard</a></li>
...
<!-- Mirrored from themezhub.net/rentup-live/rentup/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 10:21:12 GMT -->
</html>
