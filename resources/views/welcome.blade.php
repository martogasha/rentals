...
<!-- Mirrored from themezhub.net/rentup-live/rentup/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 10:17:52 GMT -->
<head>
    <meta charset="utf-8" />
                    ...
                    <div class="property-listing property-2">
                        ...
                        <div class="listing-img-wrapper">
                            ...
                            <div class="list-img-slide">
                                <div class="click">
                                    <div><a href="{{url('propertyD')}}"><img src="assets/img/p-1.png" class="img-fluid mx-auto" alt="" /></a></div>
                                    <div><a href="{{url('propertyD')}}"><img src="assets/img/p-2.png" class="img-fluid mx-auto" alt="" /></a></div>
                                    <div><a href="{{url('propertyD')}}"><img src="assets/img/p-3.png" class="img-fluid mx-auto" alt="" /></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="listing-detail-wrapper">
                            <div class="listing-short-detail-wrap">
                                ...
                                <div class="_card_list_flex">
                                    <div class="_card_flex_01">
                                        <h4 class="listing-name verified"><a href="{{url('propertyD')}}" class="prt-link-detail">7012 Shine Sehu Street, Liverpool London, LC345AC</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="call_action_wrap">
                        <div class="call_action_wrap-head">
                            ...
                            <span>We'll help you clean your office, homestead or any place.</span>
                        </div>
                        <a href="#exampleModal" data-toggle="modal" class="btn btn-call_action_wrap">Contact Us Today</a>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cleaning Details</h5>
...
<!-- Mirrored from themezhub.net/rentup-live/rentup/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 10:19:57 GMT -->
</html>
